...
@Component({
  ...
  standalone: true,
  imports: [LucideChevronLeft, LucideChevronRight, TopbarComponent, BackLinkComponent],
  templateUrl: './my-results.component.html',
  styleUrl: './my-results.component.css'
})
export class MyResultsComponent implements OnInit {
  ...
  statusColor(status: string): string {
    const map: Record<string, string> = { draft: '#C7CADA', published: '#12B886', closed: '#14141F', expired: '#E53E3E' };
